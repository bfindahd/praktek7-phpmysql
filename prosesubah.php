...
if (isset($_POST['ubah'])) {
    ...
    //cek query
    if( $pegawai ) {
        echo "<script>alert('Data Karyawan Berhasil Di Ubah!'); window.location.href='ubahdata.php'</script>";
    } else {
        echo "<script>alert('Data Karyawan Gagal Di Ubah!!'); window.location.href='ubahdata.php'</script>";
